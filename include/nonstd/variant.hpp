...
struct TypedVisitorUnwrapper<2, R, Visitor, T2>
{
    ...
    TypedVisitorUnwrapper(VisitRef<Visitor> visitor_, VisitRef<T2> val2_)
        : visitor(forward<Visitor>(visitor_))
        , val2(forward<T2>(val2_))
    ...
    {
        return visitor(forward<T>(val1), forward<T2>(val2));
    }
};
...
struct TypedVisitorUnwrapper<3, R, Visitor, T2, T3>
{
    ...
    TypedVisitorUnwrapper(VisitRef<Visitor> visitor_, VisitRef<T2> val2_, VisitRef<T3> val3_)
        : visitor(forward<Visitor>(visitor_))
        , val2(forward<T2>(val2_))
        , val3(forward<T3>(val3_))
    ...
    R operator()(VisitRef<T> val1) const
    {
        return visitor(forward<T>(val1), forward<T2>(val2), forward<T3>(val3));
    }
};
...
struct TypedVisitorUnwrapper<4, R, Visitor, T2, T3, T4>
{
    ...
    TypedVisitorUnwrapper(VisitRef<Visitor> visitor_, VisitRef<T2> val2_, VisitRef<T3> val3_, VisitRef<T4> val4_)
        : visitor(forward<Visitor>(visitor_))
        , val2(forward<T2>(val2_))
        , val3(forward<T3>(val3_))
        , val4(forward<T4>(val4_))
    ...
    R operator()(VisitRef<T> val1) const
    {
        return visitor(forward<T>(val1), forward<T2>(val2), forward<T3>(val3), forward<T4>(val4));
    }
};
...
struct TypedVisitorUnwrapper<5, R, Visitor, T2, T3, T4, T5>
{
    ...
    TypedVisitorUnwrapper(VisitRef<Visitor> visitor_, VisitRef<T2> val2_, VisitRef<T3> val3_, VisitRef<T4> val4_, VisitRef<T5> val5_)
        : visitor(forward<Visitor>(visitor_))
        , val2(forward<T2>(val2_))
        , val3(forward<T3>(val3_))
        , val4(forward<T4>(val4_))
        , val5(forward<T5>(val5_))
    ...
    R operator()(VisitRef<T> val1) const
    {
        return visitor(forward<T>(val1), forward<T2>(val2), forward<T3>(val3), forward<T4>(val4), forward<T5>(val5));
    }
};
...
struct VisitorUnwrapper
{
    ...
    R operator()(VisitRef<T1> val1) const
    {
    ...
    R operator()(VisitRef<T1> val1, VisitRef<T2> val2) const
    {
        typedef TypedVisitorUnwrapper<3, R, Visitor, T1, T2> visitor_type;
        return VisitorApplicator<R>::apply(
            visitor_type(
                forward<Visitor>(visitor),
                forward<T1>(val1), forward<T2>(val2)),
            forward<V2>(r)
        );
    }
    
    template< typename T1, typename T2, typename T3 >
    R operator()(VisitRef<T1> val1, VisitRef<T2> val2, VisitRef<T3> val3) const
    {
        typedef TypedVisitorUnwrapper<4, R, Visitor, T1, T2, T3> visitor_type;
        return VisitorApplicator<R>::apply(
            visitor_type(
                forward<Visitor>(visitor),
                forward<T1>(val1), forward<T2>(val2), forward<T3>(val3)),
            forward<V2>(r)
        );
    }
    
    template< typename T1, typename T2, typename T3, typename T4 >
    R operator()(VisitRef<T1> val1, VisitRef<T2> val2, VisitRef<T3> val3, VisitRef<T4> val4) const
    {
        typedef TypedVisitorUnwrapper<5, R, Visitor, T1, T2, T3, T4> visitor_type;
        return VisitorApplicator<R>::apply(
            visitor_type(
                forward<Visitor>(visitor),
                forward<T1>(val1), forward<T2>(val2), forward<T3>(val3), forward<T4>(val4)),
            forward<V2>(r)
        );
    }
    
    template< typename T1, typename T2, typename T3, typename T4, typename T5 >
    R operator()(VisitRef<T1> val1, VisitRef<T2> val2, VisitRef<T3> val3, VisitRef<T4> val4, VisitRef<T5> val5) const
    {
        typedef TypedVisitorUnwrapper<6, R, Visitor, T1, T2, T3, T4, T5> visitor_type;
        return VisitorApplicator<R>::apply(
            visitor_type(
                forward<Visitor>(visitor),
                forward<T1>(val1), forward<T2>(val2), forward<T3>(val3), forward<T4>(val4), forward<T5>(val5)),
            forward<V2>(r)
        );
    }
...
struct VisitorApplicator
{
    ...
    static R apply(VisitRef<Visitor> v, VisitRef<V1> arg)
    {
        switch( arg.index() )
        {
            case 0: return apply_visitor<0>(forward<Visitor>(v), forward<V1>(arg));
            case 1: return apply_visitor<1>(forward<Visitor>(v), forward<V1>(arg));
            case 2: return apply_visitor<2>(forward<Visitor>(v), forward<V1>(arg));
            case 3: return apply_visitor<3>(forward<Visitor>(v), forward<V1>(arg));
            case 4: return apply_visitor<4>(forward<Visitor>(v), forward<V1>(arg));
            case 5: return apply_visitor<5>(forward<Visitor>(v), forward<V1>(arg));
            case 6: return apply_visitor<6>(forward<Visitor>(v), forward<V1>(arg));
            case 7: return apply_visitor<7>(forward<Visitor>(v), forward<V1>(arg));
            case 8: return apply_visitor<8>(forward<Visitor>(v), forward<V1>(arg));
            case 9: return apply_visitor<9>(forward<Visitor>(v), forward<V1>(arg));
            case 10: return apply_visitor<10>(forward<Visitor>(v), forward<V1>(arg));
            case 11: return apply_visitor<11>(forward<Visitor>(v), forward<V1>(arg));
            case 12: return apply_visitor<12>(forward<Visitor>(v), forward<V1>(arg));
            case 13: return apply_visitor<13>(forward<Visitor>(v), forward<V1>(arg));
            case 14: return apply_visitor<14>(forward<Visitor>(v), forward<V1>(arg));
            case 15: return apply_visitor<15>(forward<Visitor>(v), forward<V1>(arg));
